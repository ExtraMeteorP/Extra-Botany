...
public class ModelVoidHerrscher extends ModelBiped {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.Shield1.rotateAngleY = (float) (MathHelper.sin(ageInTicks * 0.1F)
				+ Math.PI * 2 / ((EntityVoidHerrscher) entityIn).getShields() * 1);
		this.Shield2.rotateAngleY = (float) (MathHelper.sin(ageInTicks * 0.1F)
				+ Math.PI * 2 / ((EntityVoidHerrscher) entityIn).getShields() * 2);
		this.Shield3.rotateAngleY = (float) (MathHelper.sin(ageInTicks * 0.1F)
				+ Math.PI * 2 / ((EntityVoidHerrscher) entityIn).getShields() * 3);
	}
