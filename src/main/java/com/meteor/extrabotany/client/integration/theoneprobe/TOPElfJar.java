...
public class TOPElfJar implements IProbeInfoProvider{
	   
		@Override
	    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data){
			if(world.getTileEntity(data.getPos()) instanceof TileElfJar){
				TileElfJar tile = (TileElfJar) world.getTileEntity(data.getPos());
