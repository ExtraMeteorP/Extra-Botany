...
public class LexiconData {
	...
	public static void init() {	
		...
		herrscher = new DreamAdvancementEntry(LibLexicon.VOIDHERRSCHER, ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		herrscher.setLexiconPages(new PageText("0"),
				new PageCraftingRecipe("1", getResource("recipe_voidcaller")),
				new PageText("2"),
				new PageText("3"),
				new PageText("4"),
				new PageText("5"),
		...
		cosmetic.setLexiconPages(new PageText("0"),
				new PageCraftingRecipe("1", getResource("recipe_redscarf")),
		...
		bottledstar.setLexiconPages(new PageText("0"),
					new PageCraftingRecipe("1", getResource("recipe_bottledstar")));
		...
		ticket = new DreamAdvancementEntry(LibLexicon.TICKET,  ExtraBotanyAPI.dreamCategory, LibAdvancements.NATUREORB_CRAFT);
		ticket.setLexiconPages(new PageText("0"),
				new PageCraftingRecipe("1", getResource("recipe_ticket")));
		
		magicfinger = new DreamAdvancementEntry(LibLexicon.MAGICFINGER,  ExtraBotanyAPI.dreamCategory, LibAdvancements.MAGICFINGERGET);
		magicfinger.setLexiconPages(new PageText("0"),
				new PageCraftingRecipe("1", getResource("recipe_magicfinger")));
		
		manadriverring = new DreamAdvancementEntry(LibLexicon.MANADRIVERRING,  ExtraBotanyAPI.dreamCategory, LibAdvancements.MANADRIVERRING);
		manadriverring.setLexiconPages(new PageText("0"),
				new PageCraftingRecipe("1", getResource("recipe_manadriverring")));
		
		jingweifeather = new DreamAdvancementEntry(LibLexicon.JINGWEIFEATHER,  ExtraBotanyAPI.dreamCategory, LibAdvancements.JINGWEIFEATHER);
		...
		gaia3 = new DreamAdvancementEntry(ExtraBotany.naturalpledgeLoaded ? LibLexicon.GAIA_IV : LibLexicon.GAIA_III,  ExtraBotanyAPI.dreamCategory, LibAdvancements.NATUREORB_CRAFT);
		...
		failnaught = new DreamAdvancementEntry(LibLexicon.RELIC_FAILNAUGHT,  ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		failnaught.setLexiconPages(new PageText("0"),
					new PageCraftingRecipe("1", getResource("recipe_failnaught")));
		
		spearsubspace = new DreamAdvancementEntry(LibLexicon.RELIC_SPEARSUBSPACE, ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		...
		camera = new DreamAdvancementEntry(LibLexicon.RELIC_CAMERA,  ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		camera.setLexiconPages(new PageText("0"),
					new PageCraftingRecipe("1", getResource("recipe_camera")));
		
		godcore = new DreamAdvancementEntry(LibLexicon.RELIC_GODCORE,  ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		...
		relicshield = new DreamAdvancementEntry(LibLexicon.RELIC_RELICSHIELD,  ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		relicshield.setLexiconPages(new PageText("0"),
					new PageCraftingRecipe("1", getResource("recipe_relicshield")));
		
		relics = new DreamAdvancementEntry(LibLexicon.RELIC_RELICS,  ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
		relics.setLexiconPages(new PageText("0"));
		relics.setIcon(new ItemStack(ModItems.relics));
		
		mastermanaring = new DreamAdvancementEntry(LibLexicon.RELIC_MASTERMANARING,  ExtraBotanyAPI.dreamCategory, LibAdvancements.GAIA_DEFEAT);
