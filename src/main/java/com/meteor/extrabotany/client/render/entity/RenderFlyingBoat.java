...
import com.meteor.extrabotany.client.model.ModelBoatNew;
...
public class RenderFlyingBoat extends Render<EntityFlyingBoat>
{
    ...
    protected ModelBase modelBoat = new ModelBoatCopy();

    public RenderFlyingBoat(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityFlyingBoat entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityFlyingBoat p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityFlyingBoat entity)
    {
        return BOAT_TEXTURES[entity.getRaftType().getMetadata()];
    }
    ...
    public void renderMultipass(EntityFlyingBoat p_188300_1_, double p_188300_2_, double p_188300_4_, double p_188300_6_, float p_188300_8_, float p_188300_9_)
    {
        GlStateManager.pushMatrix();
