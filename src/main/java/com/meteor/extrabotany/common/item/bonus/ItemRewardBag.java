...
public class ItemRewardBag extends ItemBonusBase{
	...
	final int types = 4;
	public static List<WeightCategory> categorysA = new ArrayList<WeightCategory>();
	public static List<WeightCategory> categorysB = new ArrayList<WeightCategory>();
	public static List<WeightCategory> categorysC = new ArrayList<WeightCategory>();
	public static List<WeightCategory> categorysD = new ArrayList<WeightCategory>();
