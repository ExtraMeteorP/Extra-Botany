		...
		if (Loader.isModLoaded("waila")) {
			if (ConfigHandler.ENABLE_WAILAPOOL)
				FMLInterModComms.sendMessage("waila", "register",
						"com.meteor.extrabotany.client.integration.waila.WailaPool.register");
			if (ConfigHandler.ENABLE_WAILAMANAGEN)
				FMLInterModComms.sendMessage("waila", "register",
						"com.meteor.extrabotany.client.integration.waila.WailaManaGenerator.register");
			if (ConfigHandler.ENABLE_WAILAMANALIQUE)
				FMLInterModComms.sendMessage("waila", "register",
						"com.meteor.extrabotany.client.integration.waila.WailaManaLiquefaction.register");
			if (ConfigHandler.ENABLE_WAILAMANABUFFER)
				FMLInterModComms.sendMessage("waila", "register",
						"com.meteor.extrabotany.client.integration.waila.WailaManaBuffer.register");
		}
