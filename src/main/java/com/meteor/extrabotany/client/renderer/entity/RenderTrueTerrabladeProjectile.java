...
public class RenderTrueTerrabladeProjectile extends EntityRenderer<EntityTrueTerrabladeProjectile> {

    public RenderTrueTerrabladeProjectile(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public void render(EntityTrueTerrabladeProjectile weapon, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityTrueTerrabladeProjectile entity) {
