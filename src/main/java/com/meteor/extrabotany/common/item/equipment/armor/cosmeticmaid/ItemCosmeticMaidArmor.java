...
public class ItemCosmeticMaidArmor extends ItemArmor implements ISpecialArmor, IManaUsingItem, IModelReg, IPhantomInkable, IManaDiscountArmor {
    ...
    public boolean hasArmorSetItem(EntityPlayer player, int i) {
        ...
        switch (i) {
            case 0:
                return stack.getItem() == ModItems.cosmhelm || stack.getItem() == ModItems.coshelmrevealing;
            case 1:
                return stack.getItem() == ModItems.cosmchest;
            case 2:
                return stack.getItem() == ModItems.cosmleg;
            case 3:
                return stack.getItem() == ModItems.cosmboot;
        }
