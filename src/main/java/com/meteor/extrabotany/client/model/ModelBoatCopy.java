...
public class ModelBoatCopy extends ModelBase implements IMultipassModel {
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		EntityFlyingBoat EntityFlyingBoat = (EntityFlyingBoat) entityIn;
		...
		this.renderPaddle(EntityFlyingBoat, 0, scale, limbSwing);
		this.renderPaddle(EntityFlyingBoat, 1, scale, limbSwing);
	}
	...
	protected void renderPaddle(EntityFlyingBoat boat, int paddle, float scale, float limbSwing) {
