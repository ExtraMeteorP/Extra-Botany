...
public class ModPedestalRecipe {
	...
	public static void init() {
		mashedPotato = ExtraBotanyAPI.registerPedestalRecipe(new ItemStack(ModItems.gildedmashedpotato),
				new ItemStack(ModItems.material, 1, 2));

		fragment = ExtraBotanyAPI.registerPedestalRecipe(new ItemStack(ModItems.material),
