...
public class ConfigHandler {
	...
	private void syncConfigs() {
		...
		REWARDBAG1 = CONFIG.getStringList("Reward Bag A list", Configuration.CATEGORY_GENERAL, new String[]{"botania:petal:6:0:6","botania:petal:6:1:6","botania:petal:6:2:6","botania:petal:6:3:6",
				...
				"botania:petal:6:12:6","botania:petal:6:13:6","botania:petal:6:14:6","botania:petal:6:15:6"}, descReward);
		REWARDBAG2 = CONFIG.getStringList("Reward Bag B list", Configuration.CATEGORY_GENERAL, new String[]{"botania:rune:8:0:2","botania:rune:8:1:2","botania:rune:8:2:2","botania:rune:8:3:2",
				...
				"botania:rune:3:12","botania:rune:3:13","botania:rune:3:14","botania:rune:3:15"}, descReward);
		REWARDBAG3 = CONFIG.getStringList("Reward Bag C list", Configuration.CATEGORY_GENERAL, new String[]{"botania:manaresource:12:0:5", "botania:manaresource:12:1:5", "botania:manaresource:12:2:5",
				"botania:manaresource:9:4", "botania:manaresource:10:23:12", "botania:manaresource:7:14", "botania:manaresource:8:5:4",
				"botania:manaresource:11:7:3","botania:manaresource:11:8:3","botania:manaresource:11:9:3",
				"extrabotany:material:1:3"}, descReward);
		REWARDBAG4 = CONFIG.getStringList("Reward Bag D list", Configuration.CATEGORY_GENERAL, new String[]{"minecraft:iron_ingot:24:0:6","minecraft:diamond:13:0:2","minecraft:coal:28:0:8",
				"minecraft:gold_ingot:17:0:5","minecraft:ender_pearl:18:0:4","minecraft:redstone:18:0:12",
				"botania:blacklotus:15:0:3","botania:overgrowthseed:10:0:2",
				"extrabotany:buddhistrelics:1"}, descReward);
		REWARDBAG5 = CONFIG.getStringList("Reward Bag E list", Configuration.CATEGORY_GENERAL, new String[]{"extrabotany:rewardbag:30:0:16","extrabotany:rewardbag:20:1:10","extrabotany:rewardbag:10:2:6","extrabotany:rewardbag:10:3:6",
				"botania:manaresource:20:14","botania:manaresource:14:4:5","extrabotany:material:45:6","extrabotany:material:1:3"}, descReward);
			
		REWARDBAG6 = CONFIG.getStringList("Candy Bag list", Configuration.CATEGORY_GENERAL, new String[]{"extrabotany:candy:25:0:3","extrabotany:candy:25:1:3","extrabotany:candy:25:2:3",
				"minecraft:pumpkin_pie:15","minecraft:gold_ingot:10","minecraft:golden_apple:1:1"}, descReward);
		...
		TICKS = CONFIG.getInt("interval bewteen fishing", "annoying flower", 400, 1, Integer.MAX_VALUE, "");	
		...
		EO_COST = CONFIG.getInt("mana cost for each enchanted soil", "enchantedorchid", 250000, 1, Integer.MAX_VALUE, "");
