...
public class ItemSuperCrown extends ItemBauble implements ICosmeticBauble {
    ...
    public boolean hasArmorSetItem(EntityPlayer player, int i) {
        ...
        switch (i) {
            case 0:
                return stack.getItem() == ModItems.cosmhelm || stack.getItem() == ModItems.coshelmrevealing || stack.getItem() == ModItems.cmhelm || stack.getItem() == ModItems.cmhelmrevealing;
            case 1:
                return stack.getItem() == ModItems.cosmchest || stack.getItem() == ModItems.cmchest || stack.getItem() == ModItems.cmchestdarkened;
            case 2:
                return stack.getItem() == ModItems.cosmleg || stack.getItem() == ModItems.cmleg;
            case 3:
                return stack.getItem() == ModItems.cosmboot || stack.getItem() == ModItems.cmboot;
        }
