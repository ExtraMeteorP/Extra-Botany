...
public class ItemHammerUltimate extends ItemHammer implements IManaItem, ISequentialBreaker{
	...
	public void onUpdate(ItemStack par1ItemStack, World world, Entity par3Entity, int par4, boolean par5) {
		...
		if(!world.isRemote && par3Entity.ticksExisted % (40 - getRepair(par1ItemStack) * 10) == 0 && ManaItemHandler.requestManaExact(par1ItemStack, (EntityPlayer)par3Entity, (getManaPerDamage() - getRepair(par1ItemStack) * 5), true)){
