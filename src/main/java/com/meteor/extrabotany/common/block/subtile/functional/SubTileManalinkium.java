...
public class SubTileManalinkium extends SubTileFunctional {
	...
	private static final BlockPos[] QUARTZ_LOCATIONS = { new BlockPos(2, -1, 2), new BlockPos(2, -1, 1),
	...
	private static final BlockPos[] LAMP_LOCATIONS = { new BlockPos(1, -1, 1), new BlockPos(-1, -1, 1),
			new BlockPos(1, -1, -1), new BlockPos(-1, -1, -1) };

	private static final BlockPos[] PILLAR_LOCATIONS = { new BlockPos(1, -1, 0), new BlockPos(0, -1, 1),
