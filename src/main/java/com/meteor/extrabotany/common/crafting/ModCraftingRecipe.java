...
public class ModCraftingRecipe {
	...
	public static void init() {
		...
		LENSPOTION = new ShapelessOreRecipe(getResource("recipe_lenspotion"), new ItemStack(ModItems.lens, 1, 3), new ItemStack(vazkii.botania.common.item.ModItems.lens), LibOreDict.RUNE[4], LibOreDict.MANA_POWDER, LibOreDict.DRAGONSTONE, LibOreDict.ENDER_AIR_BOTTLE);
		LENSPOTION.setRegistryName(getResource("recipe_lenspotion"));
		
		LENSCLOUD = new ShapelessOreRecipe(getResource("recipe_lenscloud"), new ItemStack(ModItems.lens, 1, 4), new ItemStack(vazkii.botania.common.item.ModItems.lens), LibOreDict.RUNE[6], LibOreDict.MANA_POWDER, LibOreDict.DRAGONSTONE, LibOreDict.ENDER_AIR_BOTTLE);
		...
		JINGWEIFEATHER = new ShapelessOreRecipe(getResource("recipe_jingweifeather"), new ItemStack(ModItems.jingweifeather), new ItemStack(Items.FEATHER), new ItemStack(ModItems.material, 1, 3), new ItemStack(Items.LAVA_BUCKET));
		JINGWEIFEATHER.setRegistryName(getResource("recipe_jingweifeather"));
		
		MANADRIVERRING = new ShapelessOreRecipe(getResource("recipe_manadriverring"), new ItemStack(ModItems.manadriverring), new ItemStack(vazkii.botania.common.item.ModItems.manaRing), new ItemStack(ModItems.material, 1, 3), LibOreDict.PIXIE_DUST);
