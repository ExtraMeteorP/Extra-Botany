...
public class ModelArmorShadowWarrior extends ModelArmor{
	...
	public ModelArmorShadowWarrior(EntityEquipmentSlot slot) {
        ...
        this.legR.addChild(this.a1);
        this.legR.addChild(this.a2);
        this.legR.addChild(this.a3);
