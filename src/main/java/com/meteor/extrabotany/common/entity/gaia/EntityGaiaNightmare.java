...
public class EntityGaiaNightmare extends EntityLiving implements IBotaniaBoss, IEntityWithShield{
	...
	public EntityGaiaNightmare(World world) {
		super(world);
		setSize(0.6F, 1.8F);
		isImmuneToFire = true;
	...
	public static boolean spawn(EntityPlayer player, ItemStack stack, World world, BlockPos pos, boolean hardcore) {
		if(world.getTileEntity(pos) instanceof TileEntityBeacon && isTruePlayer(player)) {
			...
			EntityGaiaNightmare e = new EntityGaiaNightmare(world);
