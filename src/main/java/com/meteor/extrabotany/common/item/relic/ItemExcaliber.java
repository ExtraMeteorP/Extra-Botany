...
public class ItemExcaliber extends ItemSword
		implements IRelic, ILensEffect, IModelReg, IManaUsingItem, IAdvancementRequired {
	...
	public void updateBurst(IManaBurst burst, ItemStack stack) {
		...
		if (homeID == -1) {
			AxisAlignedBB axis1 = new AxisAlignedBB(entity.posX - 5F, entity.posY - 5F, entity.posZ - 5F,
	...
	public boolean collideBurst(IManaBurst burst, RayTraceResult arg1, boolean arg2, boolean dead, ItemStack arg4) {
		...
		if (burst.getColor() == 0XFFAF00)
			entity.getEntityWorld().spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, entity.posX, entity.posY,
					entity.posZ, 1D, 0D, 0D);
		return dead;
	}
