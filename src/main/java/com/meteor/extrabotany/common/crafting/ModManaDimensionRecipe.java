...
public class ModManaDimensionRecipe {
	...
	public static void init() {
		enderPearlRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Items.ENDER_PEARL), "gemDiamond",
				tier3);
		shulkerShellRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Items.SHULKER_SHELL),
				new ItemStack(Items.DIAMOND_HORSE_ARMOR), tier3);
		chorusRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Items.CHORUS_FRUIT),
				new ItemStack(Items.APPLE), tier1);
		endStoneRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Blocks.END_STONE), "stone", tier1);

		netherRackRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Blocks.NETHERRACK), "cobblestone",
				tier1);
		...
		blazeRodRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Items.BLAZE_ROD, 2), "rodBlaze",
				tier3);

		totemRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Items.TOTEM_OF_UNDYING),
				new ItemStack(Items.NETHER_STAR), tier4);
		elytraRecipe = ExtraBotanyAPI.registerManaDimensionRecipe(new ItemStack(Items.ELYTRA),
				new ItemStack(ModItems.flyingboat, 1, 1), tier4);
	}
