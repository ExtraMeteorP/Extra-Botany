...
public class ModEntities {
	...
	public static void init() {
		...
		EntityRegistry.registerModEntity(makeName("petpixie"), EntityPetPixie.class, "extrabotany:petpixie", id++, ExtraBotany.instance, 64, 10, true);
		EntityRegistry.registerModEntity(makeName("bottledstar"), EntityBottledStar.class, "extrabotany:bottledstar", id++, ExtraBotany.instance, 64, 10, true);
		EntityRegistry.registerModEntity(makeName("void"), EntityVoid.class, "extrabotany:void", id++, ExtraBotany.instance, 64, 10, true);
		EntityRegistry.registerModEntity(makeName("voidherrscher"), EntityVoidHerrscher.class, "extrabotany:voidherrscher", id++, ExtraBotany.instance, 64, 10, true);
		EntityRegistry.registerModEntity(makeName("subspacelance"), EntitySubspaceLance.class, "extrabotany:subspacelance", id++, ExtraBotany.instance, 64, 10, true);
		EntityRegistry.registerModEntity(makeName("honkaibeam"), EntityHonkaiBeam.class, "extrabotany:honkaibeam", id++, ExtraBotany.instance, 64, 10, true);
		EntityRegistry.registerModEntity(makeName("aurafire"), EntityAuraFire.class, "extrabotany:aurafire", id++, ExtraBotany.instance, 64, 10, true);
	}
