...
public class RenderQuantumManaBuffer extends TileEntitySpecialRenderer<TileQuantumManaBuffer> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("extrabotany:textures/model/quantummanabuffer.png");

    @Override
    public void render(@Nonnull TileQuantumManaBuffer spreader, double d0, double d1, double d2, float ticks, int digProgress, float unused) {
