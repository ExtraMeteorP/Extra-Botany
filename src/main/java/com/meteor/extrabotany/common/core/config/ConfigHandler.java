...
public class ConfigHandler {
	...
	private void syncConfigs() {
		...
		REWARDBAG3 = CONFIG.getStringList("Reward Bag C list", Configuration.CATEGORY_GENERAL, new String[]{"botania:manaresource:15:0:4", "botania:manaresource:15:1:4", "botania:manaresource:15:2:4",
				"botania:manaresource:9:4", "botania:manaresource:10:23:8", "botania:manaresource:7:14", "botania:manaresource:8:5:3",
				"botania:manaresource:11:7:3","botania:manaresource:11:8:3","botania:manaresource:11:9:3",
				"extrabotany:material:1:3"}, descReward);
		REWARDBAG4 = CONFIG.getStringList("Reward Bag D list", Configuration.CATEGORY_GENERAL, new String[]{"minecraft:iron_ingot:36:0:4","minecraft:diamond:18:0:1","minecraft:coal:40:0:6",
				"minecraft:gold_ingot:24:0:4","minecraft:ender_pearl:20:0:4","minecraft:redstone:22:0:8",
				"botania:blacklotus:16:0:2","botania:overgrowthseed:12:0:1",
				"extrabotany:buddhistrelics:1"}, descReward);
		REWARDBAG5 = CONFIG.getStringList("Reward Bag E list", Configuration.CATEGORY_GENERAL, new String[]{"extrabotany:rewardbag:33:0:16","extrabotany:rewardbag:23:1:10","extrabotany:rewardbag:13:2:6","extrabotany:rewardbag:13:3:6",
				"botania:manaresource:23:14","botania:manaresource:20:4:5","extrabotany:material:45:6","extrabotany:material:1:3"}, descReward);
