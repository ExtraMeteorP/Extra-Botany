...
public class EntityBottledStar extends EntityThrowableCopy {
	...
	public void onUpdate() {
		...
		if (this.getThrower() != null) {
			...
			Vector3 motVec = new Vector3((drange * Math.random() - range) * 18, 24,
					(drange * Math.random() - range) * 18);
			...
			if (this.ticksExisted % 4 == 0) {
				...
				AxisAlignedBB axis = new AxisAlignedBB(posX - 12F, posY - 12F, posZ - 12F, lastTickPosX + 12F,
						lastTickPosY + 12F, lastTickPosZ + 12F);
