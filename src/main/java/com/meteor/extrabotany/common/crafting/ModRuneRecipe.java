...
public class ModRuneRecipe {
	...
	public static void init() {
		...
		recipeIngotOrichalcos = BotaniaAPI.registerRuneAltarRecipe(ultimatepotato, 100000, LibOreDict.MANA_STEEL, LibOreDict.TERRA_STEEL, LibOreDict.GAIA_INGOT, LibOreDict.ELEMENTIUM, LibOreDict.MANA_DIAMOND, LibOreDict.DRAGONSTONE);
